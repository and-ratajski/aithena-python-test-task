...
class TestFunctionCounter:
    ...
    def setup_method(self):
        ...
        self.mock_responses = {
            "test_count_two_functions": json.dumps({"function_count": 2}),
            "test_count_class_methods": json.dumps({"function_count": 3}),
            "test_count_no_functions": json.dumps({"function_count": 0}),
            "test_count_complex_file": json.dumps({"function_count": 5}),
        }
